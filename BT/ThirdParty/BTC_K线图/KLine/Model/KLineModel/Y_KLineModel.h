...
@property (nonatomic, assign) double zfRate;
...
@property (nonatomic, copy) NSNumber *SMA;

@property (nonatomic, copy) NSNumber *SMB;

//资金净流入
@property (nonatomic, copy) NSNumber * netInflow;
