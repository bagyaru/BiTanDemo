...
- (void)draw
{
    ...
    if (_MAType == Y_BOLL_DN || _MAType == Y_BOLL_MB || _MAType == Y_BOLL_UP){
        ...
        UIColor *lineColor = self.MAType == Y_MA7Type ? [UIColor ma7Color] : (self.MAType == Y_MA10Type ? [UIColor ma10Color] : self.MAType == Y_MA30Type ? [UIColor ma30Color] : [UIColor mainTextColor]);
