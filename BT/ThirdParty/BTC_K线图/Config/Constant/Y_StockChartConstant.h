 ...
 *  K线图缩放界限
 */
//#define Y_StockChartScaleBound 0.00000001
 ...
 *  长按时的线的宽度
 */
#define Y_StockChartLongPressVerticalViewWidth 1
...
typedef NS_ENUM(NSInteger, Y_StockChartTargetLineStatus) {
    ...
    Y_StockChartTargetLineStatusKDJ,    //KDJ线
     Y_StockChartTargetLineStatusRSI, // RSI线条
     Y_StockChartTargetLineStatusNetCapital,
