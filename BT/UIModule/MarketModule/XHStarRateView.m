...
#define ForegroundStarImage @"ic_xingxing01"
#define BackgroundStarImage @"ic_xingxing02"
...
//-(void)setNumberStar:(NSInteger)numberStar {
//    _numberStar    = numberStar;
//    _numberOfStars = numberStar;
//    _rateStyle = WholeStar;
//    [self createStarView];
//}
- (void)awakeFromNib{
    [super awakeFromNib];
    _numberOfStars = self.numberStar;
    _rateStyle = WholeStar;
    [self createStarView];
}
