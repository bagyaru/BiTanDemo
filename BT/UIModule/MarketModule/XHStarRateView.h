...
@property (nonatomic, assign) IBInspectable NSInteger numberStar;
@property (nonatomic, strong) IBInspectable NSString *foregroundStarImage;
@property (nonatomic, strong) IBInspectable NSString *backgroundStarImage;
