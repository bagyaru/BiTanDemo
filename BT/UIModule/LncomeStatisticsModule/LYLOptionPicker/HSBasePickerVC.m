...
-(void)initUI{
    ...
    _CurrentYear  = [arr[0] integerValue];
    _CurrentMonth = [arr[1] integerValue];
    _CurrentDay   = [arr[2] integerValue];
    ...
    [_cancleBtn setTitleColor:kThemeColor1 forState:0];
    _cancleBtn.frame = CGRectMake(0, 0, 60, 40);
    [_cancleBtn.titleLabel setFont:kSeventeenFontSize];
    ...
    [_ensureBtn setTitleColor:kThemeColor forState:0];
    [_ensureBtn.titleLabel setFont:kSeventeenFontSize];
