         ...
         determineChoose:(DetermineChoose)determineChoose
{
    ...
    [UIView animateWithDuration:kPrompt_DismisTime animations:^{
        ...
        self.determineView.Y = self.optionPickerView.Y - 42;
    }];
}
- (void)disapper
{
    [UIView animateWithDuration:kPrompt_DismisTime animations:^{
        ...
        self.optionPickerView.Y = self.currentView.Sh + 42;
...
- (UIPickerView *)optionPickerView
{
    if (!_optionPickerView) {
        ...
        _optionPickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, self.currentView.Sh + 42, self.currentView.Sw, self.currentView.Sh/4)];
...
- (UIView *)determineView
{
    if (!_determineView) {
        ...
        [determineBT setTitle:[APPLanguageService wyhSearchContentWith:@"queding"] forState:UIControlStateNormal];
        ...
        [cancellBT setTitleColor:kThemeColor forState:UIControlStateNormal];
        [cancellBT setTitle:[APPLanguageService wyhSearchContentWith:@"quxiao"] forState:UIControlStateNormal];
