...
//绘制扫描区域
- (void)drawScanView {
    _scanRectView = [[MMScanView alloc] initWithFrame:CGRectMake(VIEW_TX(self.view), -50, VIEW_W(self.view), VIEW_H(self.view)) style:@""];
...
- (void)drawFlashBtn {
    ...
    [_flashBtn setCenter:CGPointMake(self.view.center.x, self.view.center.y + kFlash_Y_PAD(70)-50)];
