...
@interface ZJUnFoldLabel : BTCopyLabel
@end

@interface ZJUnFoldButton : BTButton
@end
...
@property (nonatomic, assign) BOOL isOrNotCanClick;

/** 展开/收回操作 */
@property (nonatomic, copy) void(^unFoldActionBlock)(BOOL isUnFold);

@property (nonatomic, strong) ZJUnFoldLabel  *unFoldLabel;/**< 内容标签 */;
@property (nonatomic, strong) ZJUnFoldButton *unFoldButton;      /**< 展开/折叠按钮 */;
/**
