...
+ (UIButton*)buttonWithTitle:(NSString *)title image:(NSString*)imageName selectImageName:(NSString*)selectImage font:(UIFont*)font titleColor:(UIColor*)titleColor;
...
+ (UIButton*)buttonWithType:(UIButtonType)type size:(CGSize)size title:(NSString*)title titleColor:(UIColor*)color titleFont:(UIFont*)font gradientColor:(NSArray*)gradientColors completionBlock:(ActionBlock)block;
