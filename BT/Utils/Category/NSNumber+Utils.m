...
- (NSString*)upP2fString{
    ...
    return [self upRoundCeilingStringWithScale:2];
}

- (NSString*)upP8fString{
    return [self upRoundCeilingStringWithScale:8];
}


- (NSString*)downP2fString{
    NSString *str = [self formatP2f];
    if ([str rangeOfString:@"."].location != NSNotFound) {
        NSRange ran = [str rangeOfString:@"."];
        if (str.length - ran.location == 2) {
    ...
    return [self downRoundCeilingStringWithScale:2];
}

- (NSString*)downP8fString{
    return [self downRoundCeilingStringWithScale:8];
}
...
- (NSString *)upRoundCeilingStringWithScale:(NSInteger)scale{
    ...
    NSDecimalNumber *number = [[[NSDecimalNumber alloc] initWithDouble:[self doubleValue]] decimalNumberByRoundingAccordingToBehavior:[NSDecimalNumberHandler decimalNumberHandlerWithRoundingMode:NSRoundUp scale:scale raiseOnExactness:NO raiseOnOverflow:NO raiseOnUnderflow:NO raiseOnDivideByZero:NO]];
    
    return [formatter stringFromNumber:number];
}
- (NSString *)downRoundCeilingStringWithScale:(NSInteger)scale{
    ...
    NSDecimalNumber *number = [[[NSDecimalNumber alloc] initWithDouble:[self doubleValue]] decimalNumberByRoundingAccordingToBehavior:[NSDecimalNumberHandler decimalNumberHandlerWithRoundingMode:NSRoundDown scale:scale raiseOnExactness:NO raiseOnOverflow:NO raiseOnUnderflow:NO raiseOnDivideByZero:NO]];
