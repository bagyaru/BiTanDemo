...
//        stringLanguage = @"en";
//    }
//    NSString *stringLegalTendeType;
//    if ([APPLanguageService readLegalTendeType].length > 0) {
//        stringLegalTendeType = [APPLanguageService readLegalTendeType];
//    }else {
//
//        stringLegalTendeType = @"1";
//    }
    [request setValue:ApplicationIdValue forHTTPHeaderField:ApplicationId];
    [request setValue:ApplicationClientTypeValue forHTTPHeaderField:ApplicationClientType];
    [request setValue:@"cn" forHTTPHeaderField:langLanguageType];
    [request setValue:@"1" forHTTPHeaderField:legalTendeType];
    [request setValue:AppVersionValue forHTTPHeaderField:AppVersion];
    [request setValue:@"20" forHTTPHeaderField:BuildVersion];
    //设置本次请求的数据请求格式
