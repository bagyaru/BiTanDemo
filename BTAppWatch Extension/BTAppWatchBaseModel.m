...
@end
@implementation BTAppWatchBaseModel
/**
 @brief 从字典创建对象
...
- (void)copyFromSuperOrSubObject:(BTAppWatchBaseModel *)object
{
    Class c;
...
+ (void)copyInstance:(BTAppWatchBaseModel *)one toAnotherInstance:(BTAppWatchBaseModel *)two
{
    if (self == [BTAppWatchBaseModel class])
    {
        return;
    }
...
- (id)decodeNSDictionaryValue:(id)value withProperty:(NSString *)propertyName andTypeName:(NSString *)typeName;
{
    ...
    if ([c isSubclassOfClass:[BTAppWatchBaseModel class]])
    {
        BTAppWatchBaseModel *instance = [c objectWithDictionary:value];
        return instance;
    }
    return value;
}
...
- (NSArray *)decodeArrayValue:(id)value withProperty:(NSString *)propertyName
{
    ...
    for (NSDictionary *d in value)
    {
        ...
        BTAppWatchBaseModel *instance = [c objectWithDictionary:d];
...
+ (id)encodeInstance:(id)instance
{
    ...
    if ([instance isKindOfClass:[NSArray class]])
    {
        ...
        {
            id oo;
            if ([o isKindOfClass:[BTAppWatchBaseModel class]])
            {
    ...
    if ([instance isKindOfClass:[NSDictionary class]])
    {
        ...
        [instance enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop)
         {
             id oo;
             if ([obj isKindOfClass:[BTAppWatchBaseModel class]])
             {
    ...
    if (![instance isKindOfClass:[BTAppWatchBaseModel class]])
    {
        return nil;
    }
    ...
    for (OCPropertyInfo *p in properties)
    {
        ...
        id oo;
        if ([v isKindOfClass:[BTAppWatchBaseModel class]])
        {
...
@implementation BTAppWatchBaseModel (save)
